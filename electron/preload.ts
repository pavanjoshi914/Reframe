...
const api: Api = {
  ...
  initialProjectPath: (recordingPath) => ipcRenderer.invoke('project:initialPath', recordingPath),
  findProjectForRecording: (recordingPath) => ipcRenderer.invoke('project:findForRecording', recordingPath),
  loadProjectAt: (filePath) => ipcRenderer.invoke('project:loadAt', filePath),
  ...
  rawEncodeBegin: (req) => ipcRenderer.invoke('export:rawBegin', req),
  rawEncodeFrame: (id, data) => ipcRenderer.invoke('export:rawFrame', id, data),
  rawEncodeEnd: (id, wav) => ipcRenderer.invoke('export:rawEnd', id, wav),
